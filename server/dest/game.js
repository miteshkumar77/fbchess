...
var getGameArray = function (chessGame) {
    var result = Array(64);
    var bd = chessGame.board();
    bd.forEach(function (bdRow, i) {
        bdRow.forEach(function (pos, j) {
            if (pos) {
...
exports.getGameCmd = function (chessGame, player, playerBlack, playerWhite, move) {
    var playerColor = player == playerBlack ? "b" : "w";
    var result = {
        from: "",
        to: "",
        msg: "",
